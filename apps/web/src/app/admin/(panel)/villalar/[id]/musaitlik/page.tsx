...
import { VillaAvailabilityClient } from './villa-availability-client';

type Props = { params: Promise<{ id: string }> };

export default async function VillaMusaitlikPage({ params }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
        <VillaAvailabilityClient villaId={id} />
      </div>
    </div>
  );
}
