...
export function AvailabilityClient({ activityId }: Props) {
  ...
  async function addSingle() {
    ...
    const base = activity?.availability ?? [];
    ...
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="mt-1 grid grid-cols-7 gap-1">
          {cells.map((day, idx) => {
            ...
            const st = getAvailabilityForDate(activity, iso);
            const border =
              st === 'full'
      ...
      <div className="rounded-2xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
        <p className="border-b border-zinc-200 px-4 py-3 text-sm font-medium dark:border-zinc-800">
          Özel günler ({activity.availability.length})
        </p>
